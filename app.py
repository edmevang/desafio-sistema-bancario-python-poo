...
class ContaCorrente(Conta):
    ...
    def sacar(self, valor):
        ...
        if excedeu_limite:
            ...
            print(
                f"\n@@@ Operação falhou! Número máximo de saques excedido.\nSaques: {numero_saques} de {self.limite_saques} saques permitidos no dia. @@@"
            )
...
def criar_cliente(clientes):
    ...
    endereco = input(
        "Informe o endereço (logradrouro, nro - bairro - cidade/sigla estado): "
    )
...
def criar_conta(numero_conta, clientes, contas):
    ...
    if not cliente:
        print(
            "\n@@@ Cliente não encontrado!, fluxo de criação de conta corrente encerrado @@@"
        )
        return
    ...
    # return {"numero_conta": numero_conta, "cliente": cliente}
...
def main():
    ...
    while True:
        ...
        if opcao == "d":
            ...
            print(
                "Operação inválida, por favor selecione novamente a operação desejada."
            )
